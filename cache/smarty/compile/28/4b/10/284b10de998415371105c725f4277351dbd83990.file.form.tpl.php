<?php /* Smarty version Smarty-3.1.19, created on 2017-08-21 11:51:01
         compiled from "/var/www/html/ps16/modules/spindok/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:150991821258c127c9c1eb69-72762689%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '284b10de998415371105c725f4277351dbd83990' => 
    array (
      0 => '/var/www/html/ps16/modules/spindok/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1503309041,
      2 => 'file',
    ),
    '703c8b63e613a261003c802127dc10a02968b4f0' => 
    array (
      0 => '/var/www/html/ps16/admin960yac2gi/themes/default/template/helpers/form/form.tpl',
      1 => 1482157020,
      2 => 'file',
    ),
    '86cb74ef277d89f86980adb163d044c7b2e62da9' => 
    array (
      0 => '/var/www/html/ps16/admin960yac2gi/themes/default/template/helpers/form/form_group.tpl',
      1 => 1482157020,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '150991821258c127c9c1eb69-72762689',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_58c127cd438ea3_21683896',
  'variables' => 
  array (
    'fields' => 0,
    'tabs' => 0,
...
<?php if ($_valid && !is_callable('content_58c127cd438ea3_21683896')) {function content_58c127cd438ea3_21683896($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/html/ps16/tools/smarty/plugins/function.counter.php';
?>
...
" class="<?php echo $_smarty_tpl->tpl_vars['input']->value['class'];?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='topform') {?>
        <div id='topform-label' >
             <div class="col-md-3 row" style="background-color: transparent;">
                <div class="top-logo">
                    <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['logoImg'], ENT_QUOTES, 'UTF-8', true);?>
" alt="contentBox" style="float:left;">
                </div>
                <div class="col-md-8 top-module-description">
                    <h1 class="top-module-title"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['moduleName'], ENT_QUOTES, 'UTF-8', true);?>
</h1>

                    <div class="top-module-sub-title"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['moduleDescription'], ENT_QUOTES, 'UTF-8', true);?>
</div>

                    <div class="top-module-my-name"><a href="http://www.spindok.com">Spindok Tracking <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['moduleVersion'], ENT_QUOTES, 'UTF-8', true);?>
</a></div>
...
<?php } else { ?>9<?php }?><?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?> col-lg-offset-3<?php }?>">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='topform') {?>
        <div class="row" style="background-color: transparent;" >
            <div class="col-md-4">
                <span><b>Shop:</b></span>
                <select id="spindok_shop_select" name="spindok_shop_select">
                    <?php  $_smarty_tpl->tpl_vars['shop'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['shop']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['shops']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['shop']->key => $_smarty_tpl->tpl_vars['shop']->value) {
$_smarty_tpl->tpl_vars['shop']->_loop = true;
?>
                        <option id="id_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shop']->value['id_shop'], ENT_QUOTES, 'UTF-8', true);?>
" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shop']->value['id_shop'], ENT_QUOTES, 'UTF-8', true);?>
"
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '150991821258c127c9c1eb69-72762689');
content_599aad07581028_42838972($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-08-21 11:51:03
         compiled from "/var/www/html/ps16/admin960yac2gi/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_599aad07581028_42838972')) {function content_599aad07581028_42838972($_smarty_tpl) {?>
