...
*}
    ...
    <script type="text/javascript">
        ...
        var orderRef = '{$order_reference}#{$product_ordering}'+' '+'{$product_name}'; /* You MUST keep the blank space */
        var payoutCodes = '';
        var offlineCode = '';
        {* var uid = 'PRODUCT_UID'; *}
    ...
    <script type="text/javascript" src="//scripts.affilired.com/v2/confirmation.php?merid={$merchant_id|escape:nofilter}&uid={$product.product_id}">
    </script>
    <script type="text/javascript">
